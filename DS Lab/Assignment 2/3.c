// Delete three different numbers from three different positions of an array. Underflow must be handled.
#include <stdio.h>
int main()
{
    int arr[100], size;
    ...
    scanf("%d", &element2);
    printf("Enter third element to delete: ");
    scanf("%d", &element3);
